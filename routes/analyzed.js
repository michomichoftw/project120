...
exports.analyze = function(req, res) { 
	...
	if (feelingLevel >= 3) {
		analysis["analysis"][0].feelingMsg = "You are feeling good!";
		...
		analysis["analysis"][0].feelingMsg2 = "Everything will be alright!";
